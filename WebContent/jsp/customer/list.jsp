											...
											<TBODY>
												<TR>
													...
													<TD><!-- <INPUT class=textbox id=sChannel2
														...
														<s:textfield name="cust_name" maxLength="50" cssClass="textbox" cssStyle="WIDTH: 80px"></s:textfield>
														
														</TD>
													<TD>手机号码：</TD>
													<TD><!-- <INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="cust_mobile"> -->
														<s:textfield name="cust_mobile" maxLength="50" cssClass="textbox" cssStyle="WIDTH: 80px"></s:textfield>
														</TD>
											...
											<TBODY>
												...
												<TR
													...
													<s:a action="customer_showEdit" namespace="/">
														修改
														<s:param name="cust_id" value="cust_id"></s:param>
													</s:a>
													&nbsp;&nbsp;
													<%-- <a href="${pageContext.request.contextPath }/customerServlet?method=delete&custI<!--  -->d=${customer.cust_id}">删除</a> --%>
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												<select name="pagination.pageSize">
													...
													<option value="10" <s:if test="#pagination.pageSize==10">selected</s:if>>10</option>
												</select>
												条
